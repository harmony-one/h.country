...
export const regexes: RegexObject[] = [
    { type: 'g', name: 'GitHub', regex: /https?:\/\/(?:www\.)?github\.com\/([^\n "/]+)/gi },
    { type: 'ig', name: 'Instagram', regex: /https?:\/\/(?:www\.)?instagram\.com\/([^\n "/]+)/gi },
    { type: 'f', name: 'Facebook', regex: /https?:\/\/([_a-z]{0,3}\.|[_a-z]{2}-[_a-z]{2}\.)?(facebook|fb)\.com\/(groups\/)?([^\n "/]+)/gi },
    { type: 'l', name: 'LinkedIn', regex: /https?:\/\/([_a-z]{0,3}\.)?linkedin\.com\/(((sales\/)?(in|pub|people|company|companies|organization|edu|school|groups)\/)|(profile\/view\?id=[a-z]))([^\n ]+)/gi },
    { type: 't', name: 'Telegram', regex: /https?:\/\/(?:www\.)?(?:(?:t|telegram)\.me\/|telegram\.dog\/|web\.telegram\.org\/[ak]\/#@?)([^\n "/]+)/gi },
    { type: 'x', name: 'Twitter', regex: /https?:\/\/((www|mobile)\.)?(twitter|x)\.com\/([^\n "/]+)/gi },
...
export function socialUrlParser(inputText: string): ParseResult[] {
